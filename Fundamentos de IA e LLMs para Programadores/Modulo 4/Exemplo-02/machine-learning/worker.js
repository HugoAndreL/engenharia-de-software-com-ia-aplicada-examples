...
/*
    ...
    - .expandDims(0): adiciona dimensão [1, H, W, 3]
...
function preprocessImage(input) {
    return tf.tidy(() => {
        ...
        return tf.image.resizeBilinear(image, [INPUT_FORMATER_DIMENTIONS, INPUT_FORMATER_DIMENTIONS]).div(255).expandDims(0)
    });
}
...
async function runInference(tensor) {
    ...
    */
    ...
    output.forEach(output => output.dispose());
